...
type TrainingRepository interface {
	...
	SaveSessionAnswer(ctx context.Context, sessionID int64, position int, card domain.TrainingSessionCard, question string, expected string, response string, evaluation domain.AnswerEvaluation) error
