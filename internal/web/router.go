...
func NewRouter(container *handlers.Container, appLogger logger.Logger) http.Handler {
	...
	r.Method(http.MethodPost, "/course-import", container.CoursePackages)
	r.Get("/courses/{course_id}", container.Course.ServeHTTP)
	r.Get("/courses/{course_id}/export", container.CoursePackages.Export)
	...
	r.Post("/courses/{course_id}/boards/{board_id}/background", container.Boards.Background)
	r.Get("/boards", container.Boards.GlobalIndex)
	r.Post("/boards", container.Boards.CreateGlobal)
	r.Get("/boards/{board_id}", container.Boards.ServeHTTP)
	r.Post("/boards/{board_id}/background", container.Boards.Background)
	r.Post("/boards/{board_id}/nodes", container.Boards.CreateText)
	r.Post("/boards/{board_id}/media", container.Boards.Upload)
	r.Post("/boards/{board_id}/nodes/{node_id}/move", container.Boards.Move)
	r.Post("/boards/{board_id}/nodes/{node_id}/resize", container.Boards.Resize)
	r.Post("/boards/{board_id}/nodes/{node_id}/edit", container.Boards.Edit)
	r.Post("/boards/{board_id}/nodes/{node_id}/delete", container.Boards.DeleteNode)
	r.Post("/boards/{board_id}/edges", container.Boards.CreateEdge)
	r.Post("/boards/{board_id}/edges/{edge_id}/delete", container.Boards.DeleteEdge)
	r.Post("/boards/{board_id}/strokes", container.Boards.CreateStroke)
	r.Post("/boards/{board_id}/strokes/{stroke_id}/delete", container.Boards.DeleteStroke)
	r.Post("/boards/{board_id}/labels", container.Boards.CreateLabel)
